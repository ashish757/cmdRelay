...
import ActiveControlLayout from './components/ActiveControlLayout';
  ...
  return (
      <main className="h-screen w-screen bg-black flex flex-col overflow-hidden select-none touch-none text-white font-sans relative">
        ...
        <button
            ...
            className="absolute top-6 right-6 z-10 w-6 h-6 flex flex-col items-center justify-center gap-1.5"
        ...
        <ActiveControlLayout activeId={activeLayout} />
      </main>
  );
}
