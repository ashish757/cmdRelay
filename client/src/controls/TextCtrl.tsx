    ...
    return (
        <div className="w-full p-4">
           <textarea
               ...
               autoCorrect="off"
               spellCheck="false"
               className="w-full h-32 bg-background border border-border rounded-xl px-4 py-3 text-text-main outline-none focus:border-primary shadow-inner resize-none"
           />
        </div>
    );
}